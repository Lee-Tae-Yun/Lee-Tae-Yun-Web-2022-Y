            ...
            <div class="col-md-8 col-md-offset-2">
				  <form action="Boinpro.jsp" class="row">
		    		<div class="form-group" >
				      ...
				      <input type="text" class="form-control" placeholder="Enter MAX Title 20" name="btitle" maxlength='20' required>
				    </div> 
				       
				    <div class="form-group">
				      <label for="pwd">= 내용  =</label>
				      <textarea class="form-control" placeholder="Enter MAX 400" name="borad" maxlength='400' style="resize: none;" required></textarea>
				    </div>
