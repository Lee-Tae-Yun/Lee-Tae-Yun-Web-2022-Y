        ...
        <div class="primary-menu">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <%}else{%>
                    <li><a data-scroll href="#">마이페이지</a></li>
        ...
        <h1>MBTI 회원정보 수정</h1>
         <p>
            <div class="col-md-8 col-md-offset-2">
				  <form action="updatePro.jsp" class="row">
			    <div class="form-group">
			      <label for="id">= 아이디 =</label>
			      <input type="text" class="form-control" placeholder="Enter MAX ID 20" name="id" maxlength='20' value="<%=id2 %>" required>
            </div>

            <div class="form-group">
                <label for="pwd">= 비밀번호 =</label>
                <input type="password" class="form-control" placeholder="Enter MAX PW 20" name="pwd" maxlength='20' value="<%=dtos.getPwd() %>" required>
            </div>

            <div class="form-group">
                <label for="name">= 이름 =</label>
                <input type="text" class="form-control" placeholder="Enter NAME" name="name" maxlength='20' value="<%=dtos.getName() %>" required>
            </div>
            <div class="form-group">
                <label for="chacter">= 성격유형 =</label>
                <input type="text" class="form-control" placeholder="Enter MBTI" name="chacter" maxlength='20' value="<%=dtos.getChacter() %>" readonly>
            </div>

            <div class="form-group">
                <label for="udate">= 생년월일 =</label>
                <input type="date" class="form-control" name="udate" value="<%=dtos.getUdate() %>" required>
            </div>

            <div class="form-group">
                <label for="pNumber">= 전화번호 =</label>
                <input type="text" class="form-control" placeholder="Ex)010-1234-5678" name="pNumber" maxlength='13' value="<%=dtos.getpNumber() %>" required>
            </div>

            <div class="form-group">
                <label for="email">= 이메일 =</label>
                <input type="email" class="form-control" placeholder="Enter MAX EMAIL 50" name="email" maxlength='50' value="<%=dtos.getEmail() %>" required>
            </div>
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='drop.jsp'" style="border-radius: 12px;">회원 탈퇴하기</button>
